  ...
  return (
    <>
      ...
      <div className="about">
        <div className="socialmedia">
          <ul>
            <li>
              {" "}
              <a href="https://www.github.com/rajeshmn47">
                <GitHubIcon />
              </a>
            </li>
            <li>
              {" "}
              <a href="https://www.twitter.com/rajeshmn47">
                <TwitterIcon />
              </a>
            </li>
            <li>
        ...
        <div className="aboutone">
          <div className="firstline">
            <h1>HEY, MY NAME IS RAJESH</h1>{" "}
          </div>
          <div className="aboutpara">
            <p>
              Easy, online quote, fulfillment and free pickup & delivery.Get the
              best value for your gadgets, quicker{" "}
            </p>
            <p>than ever or Experience the most quickest repair service ever</p>
          </div>
          <div>
      ...
      <footer className="footers">
        <div className="foot">home</div>
        <div className="foot">projects</div>
