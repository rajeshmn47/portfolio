    ...
    <>
            ...
            <Row className="px-lg-5 pt-3">
              <Col sm={12} md={6} lg={6} xl={6}>
                <div className="pt-5">
                  ...
                  <h4 className="pt-2">I work in </h4>
              ...
              <Col sm={12} md={12} lg={6} xl={6} className="aboutContent">
                <div className="pt-lg-3 pt-xl-5">
                  ...
                  <p className="px-md-5 px-lg-0">
                    ...
                    India and I currently live in Bangalore. Now, I am looking
                    for my first job.
                  </p>
                  <p className="pt-2 px-md-5 px-lg-0">
                    I have strong Efficiency of Responsive Web Design,
                    Functionality, Authentication, REST API, Database, Git
                    GitHub, Deploy, Google Search, etc, and I try to write clean
                    and scalable code. I have been attached in programming for
                    over one and a half years. and I am open-minded. I try to
                    learn new things quickly, and I always try to keep myself
                    updated, I want to become the best programmer and dedicate
                    all my skills and talents to developing high-quality and
                    unique websites.
                  </p>
                  <a
                    href="#123"
      ...
      <section id="contact" className="pt-5 px-md-5 px-2 from_content">
        <Container fluid className="py-5 px-lg-5">
          <h2 className="text-dark text-center py-5 skills all_title_section">
            CONTACT US
          </h2>
          ...
          <Row className="pt-md-5 pt-3">
            <Col sm={12} md={12} lg={6} xl={6} className="px-lg-4">
              ...
              <div>
                <h6 className="contact pt-4 pb-2"> Bangalore,India</h6>
            ...
            <Col sm={12} md={12} lg={6} xl={6} className="px-lg-4">
              <form>
                ...
                <button
                  className="btn btn-info btn-lg d-flex ml-auto mr-2 
